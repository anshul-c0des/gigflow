      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="border-none shadow-sm bg-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Cumulative freelancer interest
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-sm bg-emerald-600 text-white relative overflow-hidden group">
          ...
          <CardContent className="relative z-10">
            ...
            <Button
              asChild
              size="sm"
              className="w-full bg-emerald-700 hover:bg-emerald-800 text-white border-none shadow-lg transition-all active:scale-[0.98]"
            >
              <Link
                href="/gigs/create"
          ...
          <CardContent className="p-0">
            {gigs.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <Link
                  href="/gigs/create"
                  className="text-emerald-700 text-sm font-semibold hover:underline mt-1"
                >
                  Post your first gig
                </Link>
              </div>
              ...
              <div className="divide-y divide-slate-50">
                {gigs.map((gig) => (
                  <div
                    key={gig._id}
                    className="group flex flex-col md:flex-row md:items-center justify-between p-6 hover:bg-emerald-50 transition-all"
                  >
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-4 mt-4 md:mt-0">
                      ...
                      <Button
                        ...
                        size="sm"
                        asChild
                        className="text-slate-400 hover:text-teal-600 hover:bg-emerald-100/70 rounded-lg px-4"
                      >
                        <Link
                          href={`/gigs/${gig._id}`}
